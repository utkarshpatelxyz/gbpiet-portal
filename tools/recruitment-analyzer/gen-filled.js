...
const S = require("./dept133-config.js");

const NAVY="FF1F3864", HEAD="FF2E5C8A", SUB="FFDCE6F1", ACC="FF305496",
      SAMPLE="FFFFFFFF", NOTE="FF7F7F7F", WHITE="FFFFFFFF", LINE="FFBFBFBF";
...
const rmLines=[
 ["","STATIC EQUIPMENT (DEPT 133) — FRAMEWORK CONFIGURATION", "title"],
 ["",""],
 ["","WHAT THIS FILE IS","h"],
 ["","This workbook holds the TR India Static Equipment (Dept 133) hiring framework — levels, skills, scoring and"],
 ["","interview questions — already filled in. The analysis tool has NO framework of its own: it reads this file."],
 ["",""],
 ...
 ["",""],
 ["","HOW TO FILL IT IN","h"],
 ["","• This copy is FILLED with the Dept 133 framework. Edit any cell to tune it; keep the sheet/column names."],
...
wb.xlsx.writeFile("Recruitment_Framework_Config_Dept133_FILLED.xlsx").then(()=>{
